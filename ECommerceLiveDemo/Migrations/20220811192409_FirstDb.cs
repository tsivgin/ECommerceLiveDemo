        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsYoutubeLink = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoBrandMapping", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoBrandMapping_BrandId",
                table: "VideoBrandMapping",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_VideoBrandMapping_VideoId",
                table: "VideoBrandMapping",
                column: "VideoId");
